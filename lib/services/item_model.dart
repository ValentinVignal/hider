...
import 'package:hider/utils/state_provider.dart';
import 'package:riverpod/riverpod.dart';

/// The item from the database.
final originalItemProvider = StreamProvider.autoDispose.family<Item, HiderPath>(
  (ref, path) {
...
final itemProvider = StateProvider.autoDisposeFamily<Item, HiderPath>((
  ref,
  path,
) {
...
final _subItemsProvider = StreamProvider.autoDispose
    .family<Iterable<Item>, HiderPath>((ref, path) {
      return FirestoreItemService.watchSubs(path);
    });

/// The ordered items in the front end.
final subItemsProvider = Provider.autoDispose
    .family<AsyncValue<Iterable<Item>>, HiderPath>((ref, path) {
...
final allItemsOfPathProvider = StreamProvider.autoDispose
    .family<List<Item>, HiderPath>((ref, path) {
