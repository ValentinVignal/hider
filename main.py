...
class PopupWindow:
    ...
    def __init__(self, master):
        ...
        self.l1 = Label(top, text=" Account: ", font=('Courier', 14), justify=CENTER)
        self.l1.pack()
        self.e1 = Entry(top, width=30)
        self.e1.pack(pady=7)
        self.l2 = Label(top, text=" Password: ", font=('Courier', 14), justify=CENTER)
        self.l2.pack()
        self.e2 = Entry(top, show='*', width=30)
        self.e2.pack(pady=7)
    ...
    def cleanup(self):
        ...
        if not path.exists():
            ...
            if self.attempts == 5:
                window.quit()
            # self.e.delete(0, 'end')
            messagebox.showerror('Incorrect Account',
                                 'Incorrect Account, attempts remaining: ' + str(5 - self.attempts))
        else:
